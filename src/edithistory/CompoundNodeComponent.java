...
public class CompoundNodeComponent extends NodeComponent {
	...
	/*
	 * @Override public NodeComponent makeOppositeComponent(EditHistoryView
	 * view) { NodeComponent first = null; NodeComponent last = null; for (int
	 * i=0; i<nodes.size(); i++){ NodeComponent n = nodes.get(i); if (i==0){
	 * first = n.makeOppositeComponent(view); last = first; } else last =
	 * n.makeOppositeComponent(view); } return view.addCompoundNode(first, last,
	 * ""); }
	 */
